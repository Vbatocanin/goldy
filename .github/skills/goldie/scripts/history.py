#!/usr/bin/env python3
"""Goldie report history.

A repo accumulates many Claude Code conversations, and each one gets its own
report under `.goldie/reports/`. This module maintains the manifest that ties them
together, `.goldie/reports/index.json`, so a master index page can link to every
