...
Register a new material "kind" (source type) so Goldie can tag references with it,
...
docs, tutorial, how-to, language, spec, book. New kinds are persisted to:
    ...
    ~/.goldie/source_types.json   {kind: {label, icon, color, bg}}
    ~/.goldie/icons.json          {icon-name: "<svg inner markup>"}
